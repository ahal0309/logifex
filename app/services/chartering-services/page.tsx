...
export const metadata: Metadata = {
  title: "Chartering Services - Logifex Freight Services",
  description:
    "Comprehensive air and vessel chartering solutions tailored to your specific logistics requirements.",
};

export default function CharteringServicesPage() {
  return (
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="space-y-6">
              ...
              <div className="text-secondary font-body-md text-sm md:text-base leading-relaxed space-y-4">
                <p>
                  Our comprehensive air and vessel chartering solutions provide flexible, reliable, and exclusive transport for your most critical cargo. Whether you are moving oversized equipment or urgently needed goods, we have the right aircraft or ship for you.
                </p>
                <p>
                  With specialized air charter for rapid delivery and full vessel chartering for massive industrial projects, we ensure your supply chain keeps moving without interruption, no matter the scale.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-secondary-container">
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                ...
                <span className="text-secondary">
                  Rapid, dedicated flights for high-value, time-critical, or oversized air shipments.
                </span>
              </div>
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                <span className="font-bold text-on-surface block mb-1">
                ...
                <span className="text-secondary">
                  Full or part cargo vessel charters for heavy lift, breakbulk, and large volume logistics.
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-secondary-container shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    ...
                    <span className="font-bold text-on-surface">Air & Sea</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Global Reach</span>
                    <span className="font-bold text-on-surface">Worldwide</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Cargo Type</span>
                    <span className="font-bold text-on-surface">OOG, Time-Critical, Bulk</span>
                  </div>
                  <div className="flex justify-between py-1">
                    <span className="text-secondary">Feature</span>
                    <span className="font-bold text-on-surface">Exclusive Capacity</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary p-6 rounded-xl text-white text-center space-y-4 shadow-md">
                ...
                <p className="text-xs text-white/80 leading-relaxed">
                  Request specialized consultation, routes, and rates for your air or vessel charter needs.
                </p>
                <Link
                  href="/quote?service=Chartering Services"
