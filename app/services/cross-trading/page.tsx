...
export const metadata: Metadata = {
  title: "Cross Trading - Logifex Freight Services",
  description:
    "Efficient cross-trade logistics, managing shipments directly between origins and destinations.",
};
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/services/cross-trading.jpeg')" }}
      >
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="space-y-6">
              ...
              <div className="text-secondary font-body-md text-sm md:text-base leading-relaxed space-y-4">
                <p>
                  Efficient cross-trade logistics, managing shipments directly between origins and destinations without entering the country of operation.
                </p>
                <p>
                  Our extensive global network allows us to coordinate freight forwarding operations worldwide seamlessly, ensuring direct delivery that minimizes transit times and logistical costs.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-secondary-container">
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                ...
                <span className="text-secondary">
                  Eliminates unnecessary transit hubs by routing cargo directly.
                </span>
              </div>
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                <span className="font-bold text-on-surface block mb-1">
                ...
                <span className="text-secondary">
                  Complete handling of sensitive switch BLs and cross-border documentation.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-secondary-container shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    ...
                    <span className="font-bold text-on-surface">Cross Trading</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Global Reach</span>
                    <span className="font-bold text-on-surface">Worldwide Ports</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Cargo Type</span>
                    <span className="font-bold text-on-surface">Various</span>
                  </div>
                  <div className="flex justify-between py-1">
                    <span className="text-secondary">Feature</span>
                    <span className="font-bold text-on-surface">Direct Delivery</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary p-6 rounded-xl text-white text-center space-y-4 shadow-md">
                ...
                <Link
                  href="/quote?service=Cross Trading"
