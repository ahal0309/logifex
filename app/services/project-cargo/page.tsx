...
export const metadata: Metadata = {
  title: "Project Cargos - Logifex Freight Services",
  description:
    "End-to-end logistics solutions for complex, heavy-lift, and large-scale project cargo.",
};
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/services/project-cargo.webp')" }}
      >
        ...
        <div className="relative z-10 w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-surface-variant font-body-lg text-sm sm:text-base leading-relaxed max-w-2xl">
              Heavy Machinery • Infrastructure Logistics
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="space-y-6">
              ...
              <div className="text-secondary font-body-md text-sm md:text-base leading-relaxed space-y-4">
                <p>
                  Expert handling and end-to-end logistics solutions for complex and large-scale project cargo. Moving massive, heavy, or out-of-gauge equipment requires specialized knowledge and rigorous planning.
                </p>
                <p>
                  From industrial machinery to infrastructure materials, our specialized teams survey routes, manage customs, and execute complex lifting and haulage operations securely and efficiently.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-secondary-container">
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                <span className="font-bold text-on-surface block mb-1">
                  Route Planning & Feasibility
                </span>
                <span className="text-secondary">
                  Detailed route surveys to ensure roads and bridges can accommodate extreme loads.
                </span>
              </div>
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                <span className="font-bold text-on-surface block mb-1">
                ...
                <span className="text-secondary">
                  Specialized cranes, multi-axle trailers, and engineered securing plans.
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-secondary-container shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    ...
                    <span className="font-bold text-on-surface">Project & Heavy Lift</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Global Reach</span>
                    <span className="font-bold text-on-surface">Worldwide Project Sites</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Cargo Type</span>
                    <span className="font-bold text-on-surface">OOG, Heavy Machinery</span>
                  </div>
                  <div className="flex justify-between py-1">
                    <span className="text-secondary">Feature</span>
                    <span className="font-bold text-on-surface">End-to-End Management</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary p-6 rounded-xl text-white text-center space-y-4 shadow-md">
                ...
                <p className="text-xs text-white/80 leading-relaxed">
                  Request specialized consultation, route surveys, and rates for your project cargo.
                </p>
                <Link
                  href="/quote?service=Project Cargos"
