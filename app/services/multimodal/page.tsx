...
export const metadata: Metadata = {
  title: "Intermodal Logistics - Logifex Freight Services",
  description:
    "Seamless coordination across multiple transportation modes (air, sea, road, rail) for efficient cargo movement and cost optimization.",
};
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/intermodal-logistics.webp')" }}
      >
        ...
        <div className="relative z-10 w-full max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-surface-variant font-body-lg text-sm sm:text-base leading-relaxed max-w-2xl">
              Combining ocean, rail, and road systems under a single consignment note for maximum efficiency.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-secondary-container shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    ...
                    <span className="font-bold text-on-surface">Multimodal Integration</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Global Reach</span>
                    <span className="font-bold text-on-surface">Worldwide (Interconnected Hubs)</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Transit Time</span>
                    <span className="font-bold text-on-surface">Flexible / Route Optimized</span>
                  </div>
                  <div className="flex justify-between py-1">
                    <span className="text-secondary">Compliance Level</span>
                    <span className="font-bold text-on-surface">Unified Documentation</span>
                  </div>
                </div>
              </div>
