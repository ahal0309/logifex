...
export const metadata: Metadata = {
  title: "Couriers - Logifex Freight Services",
  description:
    "Fast and reliable courier services for time-sensitive documents and parcels, available locally and globally.",
};
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/services/couriers.webp')" }}
      >
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="space-y-6">
              ...
              <div className="text-secondary font-body-md text-sm md:text-base leading-relaxed space-y-4">
                <p>
                  Fast and reliable courier services for time-sensitive documents and parcels. We understand the critical nature of express shipments and offer comprehensive solutions to meet tight deadlines globally.
                </p>
                <p>
                  Our network ensures rapid pickup and expedited delivery, keeping you informed with end-to-end tracking for ultimate peace of mind.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-secondary-container">
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                ...
                <span className="text-secondary">
                  Optimized routing to guarantee the fastest delivery times.
                </span>
              </div>
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                <span className="font-bold text-on-surface block mb-1">
                ...
                <span className="text-secondary">
                  Access to an extensive international network of delivery partners.
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-secondary-container shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    ...
                    <span className="font-bold text-on-surface">Local & International</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Cargo Type</span>
                    <span className="font-bold text-on-surface">Parcels, Documents</span>
                  </div>
                  <div className="flex justify-between py-1">
                    <span className="text-secondary">Feature</span>
                    <span className="font-bold text-on-surface">Express Delivery</span>
                  </div>
                </div>
              </div>
