...
export const metadata: Metadata = {
  title: "Relocation Services - Logifex Freight Services",
  description:
    "Comprehensive relocation services for residential and commercial moving with seamless coordination.",
};
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/services/relocation.webp')" }}
      >
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="space-y-6">
              ...
              <div className="text-secondary font-body-md text-sm md:text-base leading-relaxed space-y-4">
                <p>
                  Comprehensive relocation services tailored for both residential and commercial moves. We handle the heavy lifting, ensuring your assets are packed, transported, and unpacked safely.
                </p>
                <p>
                  From office relocations to household moves across the globe, our team brings meticulous planning to every project, guaranteeing minimal downtime and a seamless transition.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-secondary-container">
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                ...
                <span className="text-secondary">
                  Specialized materials and care for delicate household goods or vital office equipment.
                </span>
              </div>
              <div className="p-4 bg-surface rounded-lg border border-secondary-container text-xs">
                <span className="font-bold text-on-surface block mb-1">
                ...
                <span className="text-secondary">
                  Dedicated move coordinators guiding you through every step of the journey.
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl border border-secondary-container shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    ...
                    <span className="font-bold text-on-surface">Moving & Relocation</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Scope</span>
                    <span className="font-bold text-on-surface">Residential, Commercial</span>
                  </div>
                  <div className="flex justify-between py-1 border-b border-secondary-container/50">
                    <span className="text-secondary">Coverage</span>
                    <span className="font-bold text-on-surface">Local & International Moves</span>
                  </div>
                  <div className="flex justify-between py-1">
                    <span className="text-secondary">Feature</span>
                    <span className="font-bold text-on-surface">Full Service Packing</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary p-6 rounded-xl text-white text-center space-y-4 shadow-md">
                ...
                <p className="text-xs text-white/80 leading-relaxed">
                  Request a consultation and a tailored quote for your relocation needs.
                </p>
                <Link
                  href="/quote?service=Relocation"
