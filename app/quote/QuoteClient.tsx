...
export default function QuoteClient({ content }: { content: any[] }) {
      ...
      <section className="lg:col-span-8 order-1 lg:order-2">
        ...
        <div className="max-w-3xl mb-12">
          <span className="text-primary-container font-label-bold text-xs uppercase tracking-wider block mb-1">
            {getVal("tagline", "Rate Request & Quotation")}
          </span>
          <h1 className="font-headline-md text-3xl md:text-4xl font-bold text-on-background mb-3">
            {getVal("title", "Get a Freight Estimate")}
          </h1>
          <p className="text-secondary font-body-md text-sm leading-relaxed">
            {getVal("description", "Provide your shipment details below, and our pricing team will formulate a competitive, comprehensive quote tailored to your timeline and cargo specifications.")}
          </p>
        </div>
